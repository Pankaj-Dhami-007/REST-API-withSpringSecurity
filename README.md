# REST-API
Project Title: REST API with Spring Boot, MongoDB, Transaction Handling, and Spring Security

Project Overview: This project demonstrates how to build a RESTful API using Spring Boot. It integrates MongoDB as the database, handles transactions to ensure data consistency, and secures the API using Spring Security. The project is built with Maven, making dependency management easy and allowing it to be scalable and maintainable.

Key Features:

Spring Boot Framework: Provides an easy way to build and deploy the application.
MongoDB Integration: MongoDB is used for storing and retrieving data, utilizing its document-based database model.
Transaction Handling: Ensures data consistency by managing transactions, especially during operations that modify multiple collections.
Spring Security: Implements authentication and authorization to secure the API endpoints.
Maven for Dependency Management: Simplifies project setup and management with clear dependencies.
API Functionalities:
